...
export default function CPType (props) {
        ...
        <>
            <StepContent>
                <form onSubmit={submitType}>
                    <TextField sx={{ mb: 2, width: 1}} name="type" label="Enter Product Type Here..." variant="standard" defaultValue={props.product.type} helperText={errorText} error={errorState} />
